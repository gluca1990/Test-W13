...
<body>
    ...
    <div class="container">
        <h1 class="my-5 text-center">Modifica i dettagli di un libro</h1>

        <form method="post" action="gestione.php?action=update&id=<?=$_GET['id']?>" class="my-5">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" value="<?=$book['anno']?>" class="form-control" id="anno" placeholder="Anno di pubblicazione..." name="anno">
            </div>
            <div class="mb-3">
